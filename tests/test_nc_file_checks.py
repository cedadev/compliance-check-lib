...
def test_GlobalAttrRegexCheck_success_2():
    ...
    resp = x(Dataset(f'{EG_DATA_DIR}/tasAnom_rcp85_land-prob_uk_25km_cdf_mon_20001201-20011130.nc'))
    assert (resp.value == (2, 2))
...
def test_ValidGlobalAttrsMatchFileNameCheck_success_1(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                           ...
                                           vocabulary_ref="eustace-team:eustace")
    ds = Dataset(
        f'{EG_DATA_DIR}/nc_file_checks_data/MOHC_ocean_day.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_success_2(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                                   ...
                                                   "order": "frequency"},
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/day.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_success_3(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                                   ...
                                                   "order": "scenario"},
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/sres-a1b.nc')
    resp = x(ds)
    assert(resp.value == (4, 4)), resp.msgs
...
def test_ValidGlobalAttrsMatchFileNameCheck_success_5(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                           ...
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(
        f'{EG_DATA_DIR}/nc_file_checks_data/19981201-19991131.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_success_6(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                           ...
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/sres-a1b_ukcp18-land-prob-25km_sample_day_19981201-19991130.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_success_7(load_check_test_cvs):
    ...
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                           ...
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(
        f'{EG_DATA_DIR}/tasAnom_rcp85_land-prob_uk_25km_cdf_mon_20001201-20011130.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_fail_2(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                                   ...
                                                   "order": "frequency"},
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/duff.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_fail_3(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                           ...
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/day_duff1.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_fail_4(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                                   ...
                                                   "order": "frequency~regex:\w"},
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/day_duff2.nc')
    resp = x(ds)
    assert(resp.value == (4, 5)), resp.msgs
...
def test_ValidGlobalAttrsMatchFileNameCheck_fail_5(load_check_test_cvs):
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                                   ...
                                                   "order": "frequency~regex:\w"},
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/day_duff3.nc')
    resp = x(ds)
...
def test_ValidGlobalAttrsMatchFileNameCheck_fail_7(load_check_test_cvs):
    ...
    x = ValidGlobalAttrsMatchFileNameCheck(kwargs={"delimiter": "_",
                                           ...
                                           vocabulary_ref="ukcp:ukcp18")
    ds = Dataset(
        f'{EG_DATA_DIR}/nc_file_checks_data/tas_sres-a1b_ukcp18-land-prob-25km_sample_day_19981201-19991130.nc')
    resp = x(ds)
...
<<<<<<< HEAD:tests/test_nc_file_checks.py
    resp = x(Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/simple_nc.nc'))
    assert(resp.value == (7, 17)), resp.msgs


def test_NCVariableMetadataCheck_success_1(load_check_test_cvs):
=======
    resp = x(Dataset('checklib/test/example_data/nc_file_checks_data/simple_nc.nc'))
...
>>>>>>> master:checklib/test/test_nc_file_checks.py
    x = NCVariableMetadataCheck(kwargs={"var_id": "time", "pyessv_namespace": "product-common-variable-land"},
                                vocabulary_ref="ncas:amf")
...
<<<<<<< HEAD:tests/test_nc_file_checks.py
def test_NCVariableMetadataCheck_success_2(load_check_test_cvs):
=======
...
>>>>>>> master:checklib/test/test_nc_file_checks.py
    x = NCVariableMetadataCheck(kwargs={"var_id": "tasAnom",
                                ...
                                vocabulary_ref="ukcp:ukcp18")
    fpath = f'{EG_DATA_DIR}/tasAnom_rcp85_land-prob_uk_25km_cdf_mon_20001201-20011130.nc'
    resp = x(Dataset(fpath))
...
def test_NCVariableMetadataCheck_fail_2(load_check_test_cvs):
    x = NCVariableMetadataCheck(kwargs={"var_id": "a-dog?", "pyessv_namespace": "product-common-dimension-land"},
                             vocabulary_ref="ncas:amf")
    try:
        x(Dataset(f'{EG_DATA_DIR}/nc_file_checks_data/simple_nc.nc'))
...
def test_NetCDFFormatCheck_success():
    ...
    fpath = f'{EG_DATA_DIR}/nc_file_checks_data/simple_nc.nc'
    resp = x(Dataset(fpath))
    assert (resp.value == (1, 1)), resp.msgs
...
def test_NetCDFDimensionCheck_fail(load_check_test_cvs):
    ...
    ncfile = f"{EG_DATA_DIR}/nc_file_checks_data/amf_eg_data_bad.nc"
    x = NetCDFDimensionCheck(kwargs={"dim_id": "latitude", "pyessv_namespace": "product-common-dimension-land"},
                             vocabulary_ref="ncas:amf")
    resp = x(Dataset(ncfile))
...
def test_MainVariableAttributeCheck_fail_1():
    ncfile = f"{EG_DATA_DIR}/nc_file_checks_data/two_vars_nc.nc"
    x = MainVariableAttributeCheck(kwargs={"attr_name": "long_name", "attr_value": "Seawater Temperature"})
    resp = x(Dataset(ncfile))
    assert (resp.value == (0, 3))
